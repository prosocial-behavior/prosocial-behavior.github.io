const data = [
    ...
    },
    {
        ...
        title: 'Честност',
        text: 'Да казваме истината и да поемаме отговорност за гласа и действията си.',
        examples: [
            'Да казваме истината',
    ...
    },
    {
        ...
        title: 'Перспектива',
        text: 'Да даваме добри съвети на другите; да гледаме на света по начини, които имат смисъл за нас и за другите.',
        examples: [
    ...
    },
    {
        ...
        title: 'Самоконтрол',
        text: 'Да регулираме това, което чувстваме и правим; да бъдем дисциплинирани; да контролираме своите чувства и емоции; да намираме баланс в начина, по който се чувстваме и действаме.',
        examples: [
    ...
    },
    {
        ...
        title: 'Духовност',
        text: 'Да имаме ясни убеждения за по-висшата цел и смисъла на вселената; да имаме вярвания за смисъла на живота, които оформят поведението ни и ни носят утеха; да намираме цел в живота.',
        examples: [
